<template>
	<div class="login font-15">
		...
		<div class="flex-box align-center cardBox">
			<span class="iconfont icon-icon icon_login"></span>
			<input v-model="code" class="input_login" oninput="if(value.length>18) value=value.slice(0,18)" type="number" placeholder="请输入会员卡号" maxlength="18">
		</div>
		...
		<div class="flex-box align-center" style="justify-content:flex-end;">
			<p @click="backLogin" style="color:#676355;">老会员登录</p>
		</div>
